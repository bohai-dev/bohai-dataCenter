  ...
  <head>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $('li a[href="toRole"]').parent().addClass("active");
        });
    </script>
  </head>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h4 class="page-header"><a href="toHome" style="text-decoration: none;"><i class="glyphicon glyphicon-home"></i></a> --> <a href="" style="text-decoration: none;">权限管理</a> --> <a href="toRole" style="text-decoration: none;">角色管理</a></h1>
