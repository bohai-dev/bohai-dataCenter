...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('li a[href="toCommission"]').parent().addClass("active");
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h4 class="page-header"><a href="toHome" style="text-decoration: none;"><i
                    class="glyphicon glyphicon-home"></i></a> --> <a href="toRebateReport"
                                                                     style="text-decoration: none;">统计报表</a> --> <a
                    href="toCommission" style="text-decoration: none;">手续费维护</a></h1>
            </h4>
            <div class="row placeholders">
                ...
                <form class="form-horizontal" style="margin-bottom: 30px;">
                    <div class="form-group">
                        <div>
                            <label for="startDatepicker" class="col-sm-2 col-md-2 control-label">请选择开始时间：</label>
                            <input type="text" class="col-sm-10 col-md-2" id="startDatepicker">

                        </div>
                        <div>
                            <label for="endDatepicker" class="col-sm-2 col-md-2 control-label">请选择结束时间：</label>
                            <input type="text" class="col-sm-10 col-md-2" id="endDatepicker">

                        </div>
                    </div>
                    <div class="">
                       <%-- <label class="col-sm-2 col-md-2 control-label">请选择文件上传：</label>--%>
                        <input id="fileinput" class=""  type="file">
                        <script type="text/javascript">
                            $("#fileinput").fileinput({
                                language: 'zh',
                                uploadAsync: true,
                                uploadUrl: "uploadCommission", //异步上传地址
            ...
            <div>
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#messages" aria-controls="messages" role="tab"
                                                              data-toggle="tab">营业部返利息统计表</a></li>
                    <li role="presentation"><a href="#home" aria-controls="home" role="tab"
                                               data-toggle="tab">客户返利息统计表</a></li>
                    <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">返利息明细</a>
                    </li>
                    <li role="presentation"><a href="#settings" aria-controls="settings" role="tab" data-toggle="tab">营销人员返利息</a>
                    </li>
                </ul>
                    ...
                    <div role="tabpanel" class="tab-pane fade  in active" id="messages">
                        <form class="form-horizontal" style="margin-top: 30px">
                            <div class="form-group">
                                ...
                                <label for="reportMonth1"
                                       class="col-sm-2 col-md-1 col-md-offset-1 control-label">统计年月</label>
                                ...
                                <div class="col-sm-10 col-md-2 col-md-offset-1 ">
                                    <input class="btn btn-default col-xs-7" type="button" value="查询"
                                           onclick="queryMarketRebateReport()">
                                </div>
                            </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped" id="marketRebateTable"
                                ...
                                <tr>
                                    ...
                                    <th data-field="AVAILABLE_FUNDS" data-align="center" data-formatter="numberFormate">
                                        可用资金
                                    </th>
                                    <th data-field="INTEREST_AMOUNT" data-align="center" data-footer-formatter="footer"
                                        data-formatter="numberFormate">利息
                                    </th>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="home">
                        ...
                        <form class="form-horizontal" style="margin-top: 30px">
                            ...
                            <div class="form-group">
                                <label for="investorName"
                                       class="col-sm-2 col-md-1 col-md-offset-1 control-label">投资者姓名</label>
                                <div class="col-sm-10 col-md-2">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped" id="rebateTable"
                                ...
                                <tr>
                                    <!-- <th data-field="state" data-checkbox="true"></th> -->
                                    <th data-field="INVESTOR_NO" data-align="center" data-footer-formatter="合计">投资者编号
                                    </th>
                                    ...
                                    <th data-field="INTEREST_AMOUNT" data-align="center"
                                        data-footer-formatter="rebateTableFooter" data-formatter="numberFormate">利息
                                    </th>
                                </tr>
                                </thead>
                            </table>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="profile">
                        ...
                        <form class="form-horizontal" style="margin-top: 30px">
                            <div class="form-group">
                                ...
                                <label for="beginDate"
                                       class="col-sm-2 col-md-1 col-md-offset-1 control-label">统计开始日期</label>
                                <div class="col-sm-10 col-md-2">
                            ...
                            <div class="form-group">
                                ...
                                <label for="investorNo3"
                                       class="col-sm-2 col-md-1 col-md-offset-1 control-label">投资者账号</label>
                                <div class="col-sm-10 col-md-2">
                            ...
                            <div class="form-group">
                                ...
                                <label for="mediatorName3"
                                       class="col-sm-2 col-md-1 col-md-offset-1 control-label">居间人姓名</label>
                                <div class="col-sm-10 col-md-2">
                        ...
                        <div class="table-responsive">
                            <table id="rebateDetailTable"
                                ...
                                <tr>
                                    ...
                                    <th data-field="interestAmount" data-align="center" data-sortable="true"
                                        data-formatter="numberFormate">利息
                                    </th>
                                    <th data-field="availableFunds" data-align="center" data-sortable="true"
                                        data-formatter="numberFormate">可用资金
                                    </th>
                                    <th data-field="rights" data-align="center" data-sortable="true"
                                        data-formatter="numberFormate">客户日均权益
                                    </th>
                                </tr>
                                </thead>
                            </table>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="settings">
                        ...
                        <form class="form-horizontal" style="margin-top: 30px">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-2 col-md-offset-1 ">
                                    <input class="btn btn-default col-xs-7" type="button" value="查询"
                                           onclick="queryMarketerRebateReport()">
                                </div>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table id="marketerRebateTable"
                                ...
                                <tr>
                                    <!-- <th data-field="state" data-checkbox="true"></th> -->
                                    <th data-field="MARKETER_NO" data-align="center" data-footer-formatter="合计">营销人员编号
                                    </th>
                                    <th data-field="MARKETER_NAME" data-align="center">营销人员姓名</th>
                                    <th data-field="DEP_NAME" data-align="center">营业部</th>
                                    <th data-field="INTEREST" data-align="center" data-footer-formatter="interestFooter"
                                        data-formatter="numberFormate">返利息
                                    </th>
                                </tr>
                                </thead>
                            </table>
